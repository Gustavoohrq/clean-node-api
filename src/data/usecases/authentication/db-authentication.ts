...
export class DbAuthentication implements Authentication {
  ...
  constructor (loadAccountByEmailRepository: LoadAccountByEmailRepository, hashComparer: HashComparer, encrypt: Encrypter, updateAccessTokenRepository: UpdateAccessTokenRepository) {
